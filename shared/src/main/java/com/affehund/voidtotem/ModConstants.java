...
public class ModConstants {
	...
	public static final TagKey<Item> ADDITIONAL_TOTEMS_TAG = TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation(MOD_ID, "additional_totems"));
	public static final TagKey<Item> CURIOS_CHARM_TAG = TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation(ModConstants.CURIOS_MOD_ID, "charm"));
	public static final TagKey<Item> TRINKETS_CHARM_TAG = TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation(ModConstants.TRINKETS_MOD_ID, "charm/charm"));
}